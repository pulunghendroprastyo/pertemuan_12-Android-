...
public class edit_mahasiswa extends AppCompatActivity {
    ...
    String nim,name,address,hobby,photo;
    Button BTNUpdate;
    ImageButton IBPhoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //set value ke dalam edit text
        ...
        Picasso.get().load("http://mobile.undangmi.com/image/"+photo).into(IBPhoto);
        ...
        IBPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(edit_mahasiswa.this);
        ...
        BTNUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(edit_mahasiswa.this);
                alertDialogBuilder.setMessage("Do yo want to update this data ?");
    ...
    void validasiData(){
        if(nim.equals("") ||name.equals("") || address.equals("") || hobby.equals("")){
            ...
            Toast.makeText(edit_mahasiswa.this, "Periksa kembali data yang anda masukkan !", Toast.LENGTH_SHORT).show();
        }else {
            kirimData();
        }
    }
    ...
    public  void TakePhoto(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(edit_mahasiswa.this);
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Take a photo"))
                {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(edit_mahasiswa.this, authorities, photoFile);
                ...
                else
                {
                    ...
                    ActivityCompat.requestPermissions(edit_mahasiswa.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, CODE_GALLERY_REQUEST);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(edit_mahasiswa.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        } else {
            if (intent != null) {
    ...
    void kirimData(){
        ...
        AndroidNetworking.post("http://mobile.undangmi.com/api/updateMahasiswa.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        progressDialog.dismiss();
                        Log.d("cekedit",""+response);
                        try {
                            Boolean status = response.getBoolean("status");
                            String pesan   = response.getString("result");
                            Toast.makeText(edit_mahasiswa.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
